...
@section('admin')
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <form action="{{ route('ikan_tambah') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        <div class="card-title">Tambah Data Ikan</div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-10">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="kode_ikan" id="" class="form-control form-control-sm" required>
                                    @error('kode_ikan')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_ikan" id="" class="form-control form-control-sm" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="harga_jual" id="harga_beli"
                                        class="form-control form-control-sm" required>
                                </div>
